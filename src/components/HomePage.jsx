...
export default function HomePage({teams, matches}) {
  ...
  const getWinningTeam = (match) => {
    ...
    if (homeScore > awayScore) return { winner: 'home', team: getTeamNameById(match.ATeamID) };
    if (homeScore < awayScore) return { winner: 'away', team: getTeamNameById(match.BTeamID) };
            ...
            <div className="teams-container">
              ...
              <div className="team">
                ...
                <div className="team-info">
                  <div className="team-name">{getTeamNameById(match.ATeamID)}</div>
                </div>
              </div>
              ...
              <div className="match-result">
                ...
                <span className={isDraw ? '' : winner === 'home' ? 'win' : 'lose'}>
                  {match.Score}
                </span>
